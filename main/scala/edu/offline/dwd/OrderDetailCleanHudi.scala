...
object OrderDetailCleanHudi {
  def main(args: Array[String]): Unit = {
    ...
    val odsUserInfo=ss.read.format("hudi")
      .load("hdfs://master:8020/user/hive/warehouse/ods_ds_hudi.db/order_detail")
    ...
    //原库中无dwd_ds_hudi.db/fact_order_detail,不进行union，直接插入
    ...
    odsUserInfo.write
      ...
      .option(TBL_NAME.key(),"fact_order_detail") //表名
      .save("hdfs://master:8020/user/hive/warehouse/dwd_ds_hudi.db/fact_order_detail") //文件路径

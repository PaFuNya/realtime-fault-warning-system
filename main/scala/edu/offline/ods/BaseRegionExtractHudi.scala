...
object BaseRegionExtractHudi {
  def main(args: Array[String]): Unit = {
    ...
    val ss: SparkSession = SparkSession.builder()
      ...
      .appName("Hudi extract base_region")
      .enableHiveSupport()
      .getOrCreate()
    ...
    readMySQLDFwithCol.write
      ...
      .option(TBL_NAME.key(),"base_region") //表名
      .save("hdfs://master:8020/user/hive/warehouse/ods_ds_hudi.db/base_region") //文件路径

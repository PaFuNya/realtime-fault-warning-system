error id: file:///D:/Desktop/Match/MATCH/OverMatch/src/main/scala/org/example/tasks/FlinkRulInference.scala:
file:///D:/Desktop/Match/MATCH/OverMatch/src/main/scala/org/example/tasks/FlinkRulInference.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/flink/streaming/api/scala/TimeSeriesFeatures#
	 -TimeSeriesFeatures#
	 -scala/Predef.TimeSeriesFeatures#
offset: 26520
...
object FlinkRulInference {
  ...
  class MergeHighFreqFunction(
      highFreqStateDescriptor: MapStateDescriptor[Int, TimeSeriesF@@eatures]

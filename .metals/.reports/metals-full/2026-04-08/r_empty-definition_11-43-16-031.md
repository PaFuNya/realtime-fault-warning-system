error id: file:///D:/Desktop/Match/MATCH/OverMatch/src/main/scala/org/example/tasks/FlinkRulInference.scala:FeatureUtils.
file:///D:/Desktop/Match/MATCH/OverMatch/src/main/scala/org/example/tasks/FlinkRulInference.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/flink/streaming/api/scala/FeatureUtils.
	 -org/example/tasks/utils/FeatureUtils.
	 -FeatureUtils.
	 -scala/Predef.FeatureUtils.
offset: 11039
uri: file:///D:/Desktop/Match/MATCH/OverMatch/src/main/scala/org/example/tasks/FlinkRulInference.scala
text:
```scala
...
object FlinkRulInference {
  ...
  class HighFreqAggregator
    ...
    override def getResult(acc: HighFreqAccumulator): TimeSeriesFeatures =
      F@@eatureUtils.calculateTimeSeriesFeatures(acc)
  }

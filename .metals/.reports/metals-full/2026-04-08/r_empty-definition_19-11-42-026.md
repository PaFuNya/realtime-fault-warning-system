error id: file:///D:/Desktop/Match/MATCH/OverMatch/src/test/java/testUtils.scala:vibration.
file:///D:/Desktop/Match/MATCH/OverMatch/src/test/java/testUtils.scala
empty definition using pc, found symbol in pc: vibration.
...
object FeatureUtils {
  ...
  def accumulateFeatures(
    ...
    val vx=math.abs(value.vibration@@)
  }
